use crate::types::*;
use riscy_isa::Register::{self, *};

const STACK_SIZE: usize = 512;

const REG_MAPPING_SIZE: usize = 16;
const REG_MAPPING: [Register; REG_MAPPING_SIZE] = [
    A0, A1, A2, A3, A4, A5, T0, T1, T2, T3, S0, Zero, Zero, Zero, Zero, Zero,
];
